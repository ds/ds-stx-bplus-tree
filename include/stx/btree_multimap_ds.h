...
public:
    ...
    inline btree_multimap(void * context, const key_compare &kcf)
        : tree(context, kcf)
    {
    }
    ...
    /// constructor initializing an empy B+ tree with special key
    /// comparison object and a context for that object
    inline btree_multimap(void * context, const key_compare &kcf, AbstractShard* shard)
    ...
    /// constructor initializing an empy B+ tree with special key
    /// comparison object and a context for that object
    inline btree_multimap(void * context, const key_compare &kcf, AbstractShard* shard, IndexPrintKeyFunc printKeyFunc)
